...
class ClassificationMetrics:
    ...
    def compute_all_metrics(self, predictions, labels, average='macro'):
        metrics = {}
    ...
    def get_classification_report(self, predictions, labels, target_names=None):
        return classification_report(labels, predictions, target_names=target_names, zero_division=0)
